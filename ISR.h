...
#define MAX_NUM_PIXELS	25*2 //Because now each pixel use to bytes, so FSR counter increme
#define MAX_NUM_COLUMNS	5
#define MAX_NUM_GREYSCALE_LOW	0x2F
#define MAX_NUM_GREYSCALE_HIGH	0x02	//actually is 1
...
#define ADDRESS_M_BUFFER_MATRIX_0	0x32
#define ADDRESS_M_BUFFER_MATRIX_1	0x33
#define ADDRESS_M_BUFFER_MATRIX_2	0x34
#define ADDRESS_M_BUFFER_MATRIX_3	0x35
#define ADDRESS_M_BUFFER_MATRIX_4	0x36
#define ADDRESS_I_GREYSCALE_LOW	0x37
#define ADDRESS_I_GREYSCALE_HIGH	0x38
#define	ADDRESS_I_BUFFER_MATRIX	0x39
#define ADDRESS_I_ISR	0x3A
#define ADDRESS_COLUMN_ISR	0x3B
#define ADDRESS_ROW_ISR	0x3C
...
extern ram near unsigned int gBufferGreyscale[25];
extern ram near unsigned char mBufferMatrix[5];
extern ram near unsigned int iGreyscale; //indice que se encarga de determinar a que nivel de intensidad
...
extern ram unsigned int gPreBufferGreyscale[25];
